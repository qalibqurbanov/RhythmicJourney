...
public class ResetPasswordCommandValidator : AbstractValidator<ResetPasswordCommand>
{
    ...
    {
        RuleFor(resetPasswordCommand => resetPasswordCommand.DTO.Email)
            .NotEmpty()
        ...
        RuleFor(resetPasswordCommand => resetPasswordCommand.DTO.Password)
            .NotEmpty()
            .MinimumLength(6);

        RuleFor(resetPasswordCommand => resetPasswordCommand.DTO.PasswordConfirm)
            .NotEmpty()
            .MinimumLength(6)
            .Equal(resetPasswordCommand => resetPasswordCommand.DTO.Password).WithMessage("'Password' and 'Password Confirm' should be the same.");

        RuleFor(resetPasswordCommand => resetPasswordCommand.DTO.ResetPasswordToken)
